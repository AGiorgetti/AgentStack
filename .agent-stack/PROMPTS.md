...
Agents do not need to read this file during normal execution. Runtime behavior should come from `AGENTS.md`, `.agent-stack/README.md`, `.agent-stack/protocol/AGENT-PROTOCOL.md`, AgentStack skills, and `agentstack help ... --json`.
